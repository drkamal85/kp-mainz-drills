...
R4_TOPICS={"distale-radiusfraktur","schock","copd","lungenembolie","cholezystitis","appendizitis","ileus","wirbelsaeulenverletzungen","allgemeine-frakturlehre","polytrauma-abcde","leistenhernie","pleuraerguss","asthma-bronchiale","tvt","hypothyreose","hyperthyreose","ikterus-cholestase","proximale-femurfraktur"}
