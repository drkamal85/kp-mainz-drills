# Geparkt für spätere R2-Perlen und R3-Tab-6

Beim R1-Bau von **Hüft-/Knie-TEP** und **Aortenaneurysma** war protokollspezifischer Stoff
in die Kernstationen geraten. R1 ist Basis — Protokollbezug gehört in R2 (Perlen) und R3
(Fragen & Protokolle). Hier steht, was beim Trimmen herausgenommen wurde, damit es beim
Bau der höheren Level nicht verloren geht.
...
→ **Frühinfekt** → Revision mit Wechsel von Prothesenkopf und Inlay → **Hb-Abfall auf 6,9**,
zwei Erythrozytenkonzentrate → nach drei Wochen **Reinfekt** → **Explantation und Spacer-Einlage**.

Dokumentiert gefragt:
- Muskelansätze an Trochanter minor (M. iliopsoas) und major (Glutei, Piriformis, Obturatorii, Gemelli)
- Coxarthrose mit Risikofaktoren
- Die drei Knorpelarten
- Beckenübersicht: Prothesenlage und periprothetische Fraktur beurteilen

Weitere Perlen-Kandidaten (aus R1 entfernt, weil zu detailliert für die Basis):
- Verhaltensregeln nach Hüft-TEP: nicht über 90 Grad beugen, Beine nicht überkreuzen,
  keine tiefen Sitzmöbel, Toilettensitzerhöhung
- Einzeitiger Wechsel bei bekanntem, gut behandelbarem Erreger und guten Weichteilen
- Bei rezidivierender Luxation: Korrektur der Pfannenposition, größerer Kopf, tripolare Pfanne
...
**CT-Angiographie mit infrarenalem AAA — kompletter Prüferblock:**
- Therapie bei freier Ruptur? → notfallmäßige Laparotomie
- Therapie bei gedeckter Ruptur? → Blutung meist ins **Retroperitoneum**
- OP-Indikationen: symptomatisches AAA, ≥5,5 cm (Männer) bzw. ≥5,0 cm (Frauen)
- Alternative zur offenen OP? → EVAR
- **Die drei Warnzeichen des rupturierten AAA:** akuter abdomineller/flankenseitiger Schmerz,
  pulsatile abdominelle Masse, Hypotonie

**CT-Abdomen mit Aortenruptur:** Symptome (Schock, starke Flankenschmerzen, Hypotonie);
Behandlung interventionell EVAR, operativ **Y-Prothese**.

**Weiterer Block:** Marfan-Syndrom mit Aortenaneurysmen; Komplikationen von EVAR/TEVAR
(Endoleaks, Gefäßverletzungen, Aneurysma-Ruptur).

Weitere Perlen-Kandidaten (aus R1 entfernt):
- Grey-Turner-Zeichen bei retroperitonealem Hämatom
- Formulierungshilfe zum Beschreiben eines Aneurysma-CT
  („infrarenal spindelförmig auf … cm erweitert, wandständiger Thrombus, Nierenarterien frei,
  kein Kontrastmittelaustritt")
- EVAR-Voraussetzung: geeigneter Aneurysmahals und geeignete Beckengefäße


## Anästhesie & Atemwegssicherung — R1 gebaut 07/2026, Protokollstoff für R2/R3

**ASRAWI-Themenliste (der komplette Blockumfang, unabhängige Quelle):**
Arten der Anästhesie · Präoxygenierung und Apnoetoleranz · Komplikationen (Übelkeit, Hypotonie,
maligne Hyperthermie) · Muskelrelaxanzien und Restvolumen der Lunge · Sauerstoffverbrauch nach
Narkose · Spinalanästhesie: Wirkung, Test mit Kälte · Infiltrations- vs. Leitungsanästhesie ·
Notfallkoffer Atemwegssicherung · Indikationen für Intubation · Tracheotomie vs. Koniotomie

**Dr. Ross (Anästhesie), dokumentierter Block:**
- „Welche Anästhesie für die Operation: Spinal- oder Vollnarkose?" → Vollnarkose bei größerem Eingriff
- „Wie lange sollte präoxygeniert werden? Was ist Nitroxierung?" → mindestens 3 Minuten oder
  8 tiefe Atemzüge; Stickstoff aus den Alveolen verdrängen
- „Wie lange kann der Körper ohne Sauerstoffzufuhr während der Narkose?" → 6–8 Minuten
- Berechnung der Lungenvolumina (RV + VC = TLC)
- „Wie viel Luft ist nach Muskelrelaxans in den Lungen?" → FRC, 2,5–3 Liter
- „Wie viel Liter pro Minute Sauerstoff nach Narkose?" → 2–6 l/min über Nasenbrille

**Weitere dokumentierte Fragen:**
- Guedel- vs. Wendl-Tubus (oropharyngeal, hält die Zunge zurück / nasopharyngeal, auch beim Wachen)
- „Was enthält der Basis-Notfallkoffer ohne Medikamente?" → Beatmungsbeutel, Sauerstoff,
  Absaugkatheter, Guedel-Tuben, Laryngoskop, Stethoskop, Blutdruckmessgerät
- „Welche Medikamente im Notfallkoffer?" → Adrenalin, Atropin, Amiodaron, Midazolam, Naloxon
- Aufklärung über Intubation → Indikation, Vorgehen, Risiken (Aspiration, Zahnschäden, Stimmbandläsion)
- „Wie überprüft man die Wirksamkeit einer Spinalanästhesie?" → Wärmegefühl durch Vasodilatation,
  Test mit kaltem Gegenstand
- Warum Amid-Anästhetika bevorzugt → weniger allergische Reaktionen als Ester
- Prilocain → Methämoglobinämie, Zyanose bei Sättigung unter 90 Prozent
- Bild von Larynx und Trachea → welche Eingriffe möglich; Koniotomie vs. Tracheotomie,
  Indikation und wer sie durchführen darf
- Rettergriff / C-Griff zur Maskenbeatmung
- „GCS 5 — trotzdem keine Intubation, wann?" → palliative Situation mit DNI, nicht reversibles Koma,
  klare Atemwegspatenz
- Neurotransmitter und Rezeptor an der motorischen Endplatte → Acetylcholin, nikotinischer Rezeptor
...
## Bronchialkarzinom — R1 gebaut 07/2026, Protokollstoff für R2/R3
**Rang 44 mit 100 Treffern. Viermal war es der Prüfungsfall selbst.**

**Prof. Schmitz — Fall akute Dyspnoe, Enddiagnose Bronchialkarzinom:**
Fallvorstellung, dann detaillierte Besprechung: Differenzialdiagnose, Labor.
„Ich musste dem Tumor ein **Stadium** zuordnen. Der Patient war im **Stadium 4**, und hier waren
hauptsächlich **Palliative Maßnahmen** von Bedeutung. **Er wollte diese Maßnahmen von mir hören.**
Ihm war wichtig, wie man sich mit dem Fall auseinandersetzen kann und **was man für den Patienten
tun kann.**"

**Fall Bronchialkarzinom Stadium 4 (Herr Stefan Schmidt, Innere):**
Patient kommt per Rettungsdienst wegen zunehmender Dyspnoe und Zyanose,
V. a. exazerbierte COPD — entweder durch Pneumonie oder durch Tumorausbreitung.

**Prof. Dahm — Fall Aortenaneurysma mit gleichzeitigem Lungenkarzinom:**
Diskussion über die **Reihenfolge der Operationen** (Aorta zuerst, dann Lungenkarzinom),
danach Aortenaneurysma und aortocavale Fistel. Dann: „**Staging? Funktionelles Staging?
Was macht man vor Lobektomie?**" Anschließend CT Thorax mit **Pleuraraumforderung** →
„Was erwarten Sie, wenn ich sage, das ist ein Tumor?" → **Mesotheliom** →
„**Was soll man fragen?**" → **Was hat der Patient beruflich gemacht** (Asbest).

**Fall Prof. Dahm / Prof. Hinze / Prof. Müller-Forell:** „Der Fall war Lungenkarzinom, in der
Akte war nur OP-Aufklärung und ein paar CT-Befunde, Kontrolle von Raumforderung in der Lunge."

**CT-Bild zentrales kleinzelliges Bronchialkarzinom:** „Über die **Klassifikation** gefragt,
über die **Behandlung**, auch über Pneumonie. **Welche Untersuchung soll gemacht werden?**
Das war **Spirometrie**. Über die **Metastasierung** wurde auch gefragt."

**SIADH-Kette (Dr. Laakmann-Block):** Patient auf onkologischer Station mit **Verwirrtheit** →
Anamnese, Untersuchung, Labor → **Hypernatriämie? nein, Hyponatriämie** → Vorgehen →
**SIADH** → Diagnose und Ursache → **paraneoplastische Manifestation im Rahmen eines
kleinzelligen Lungenkarzinoms**. Danach Bluttransfusion sehr detailliert.

**Als DD:** Bei Pneumonie wollte ein Prüfer ausdrücklich **Lungenkarzinom und Tuberkulose** hören.
Beim CT-Rundherd mit randbetonter Verkalkung war dagegen **Tuberkulose** die gesuchte Antwort.

**Grenzt an andere Reviews, dort NICHT doppeln:** SIADH und Hyponatriämie stehen in
**hyponatriaemie-siadh** · Pleuraerguss und Punktion in **pleuraerguss** · Pneumonie-DD in
